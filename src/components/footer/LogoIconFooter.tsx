...
const LogoIconFooter = () => {
	return (
		<div className='md:ml-[110px] md:mt-8'>
			<img
				className='md:mt-4 cursor-pointer sm:max-md:mx-auto sm:max-md:mt-10'
				src={LogoWhite}
				alt='Footer Logo Icon'
			/>
			<div className='flex md:flex-row sm:mt-5 sm:mb-5 md:mt-10 md:mb-12 sm:max-md:justify-center sm:max-md:mx-auto'>
				<a
					className='text-netral-white hover:text-primary-lime-green transition duration-300 ease-in-out pr-2 sm:max-md:px-2 cursor-pointer'
					href='#'
				>
					<svg
				...
				<a
					className='text-netral-white hover:text-primary-lime-green transition duration-300 ease-in-out pr-2 cursor-pointer sm:max-md:px-2 '
					href='#'
				>
					<svg
						className='fill-current'
